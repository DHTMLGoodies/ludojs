    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                'countries' => '/resources/user-admin/Countries.php',
                'country' => '/resources/user-admin/Country.php',
                ...
                'user' => '/resources/user-admin/User.php',
                'users' => '/resources/user-admin/Users.php',
